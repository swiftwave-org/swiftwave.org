...
export default function GithubStarBtn() {
    ...
    return (
        <button type="button" aria-label={`Star swiftwave-org/swiftwave on GitHub (${githubStars} stars)`} className="flex flex-row gap-2 px-3 py-0.5 justify-center items-center border-[3px] border-gray-400 border-solid rounded-lg cursor-pointer hover:bg-gray-100 hover:border-primary-500 overflow-hidden bg-transparent" onClick={() => window.open("https://github.com/swiftwave-org/swiftwave", "_blank")}>
